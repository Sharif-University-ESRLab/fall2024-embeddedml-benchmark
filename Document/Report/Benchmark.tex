...
\begin{table*}[!htbp]
    ...
    \begin{tabular}{| c | c | c | c |}
        ...
        \midrule
        Visual Wake Words & Speech Communication (49 $\times$ 10) & & \\
        \midrule
        Image Classification & VWW Dataset (96 $\times$ 96) & & \\
        \midrule
        Keyword Spotting & CIFAR 10 (32 $\times$ 32) & & \\
        \midrule
        Anomaly Detection & ToyADMOS (5 $\times$ 128) & & \\
        \midrule
        Emotion Detection & & & \\
        \bottomrule
    \end{tabular}
